            ...
            child: Container(
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Gaps.vGap12,
                  const _ProviderTrackStatusTimeline(),
                  Gaps.vGap12,
                  ...
                  SizedBox(
                    ...
                    child: MyDefaultButton(
                      btnText: 'provider_track_live_ive_arrived',
                      onPressed: () {},
                      color: colors.main,
...
class _TrackStatusStep extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final Color iconColor = isActive ? colors.errorColor : colors.homeCaption;
    final Color textColor = isActive ? colors.errorColor : colors.homeCaption;
...
class _ProviderTrackStatusTimeline extends StatelessWidget {
  const _ProviderTrackStatusTimeline();
